...
// use StakeEntryData to access length of time a user's NFTs have been staked
...
function Home() {
  ...
  return (
    <div className='min-h-screen'>
      <Head>
        <title>Staking - JetGetter Club</title>
        <meta name="description" content="Welcome to the Hangar: Store your Jets, level them up, and get access to giveaways and more." />
        ...
        >
          {(maxStaked || rewardDistributorData) &&
            !stakePoolMetadata?.notFound && (
              <div
                className={`mx-5 mb-4 flex flex-wrap items-center gap-4 rounded-lg px-10 py-6 md:flex-row md:justify-between text-black'
                } ${
              ...
              >
                {stakePoolEntries.data ? (
                  ...
                  <div className="relative flex h-8 flex-grow items-center justify-center">
                    ...
                    <div className="absolute w-full animate-pulse items-center justify-center rounded-lg bg-white bg-opacity-90 p-5"></div>
                  </div>
                )}
                            ...
                            getMintDecimalAmountFromNatural(
                              ...
                              (
                                stakedTokenDatas.data?.map((stakeData) =>
                                  (
                                    stakeData.stakeEntry?.parsed.amount ||
                                    new BN(1)
                                  ).mul(
                                    (
          ...
          <div className="my-2 mx-5 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div
              className={`flex-col rounded-lg p-10 text-black
              bg-white bg-opacity-90`}
              style={{
            ...
            >
              <div className="mt-2 flex w-full flex-row justify-between">
                <div className="flex flex-row">
                  <p className="mb-3 mr-3 inline-block text-lg text-black">
                    Select Your Jets
                  </p>
                ...
                <div className="flex flex-row">
                  {!stakePoolMetadata?.hideAllowedTokens && (
                    <button
                      ...
                      className="text-md mr-5 inline-block rounded-lg bg-white bg-opacity-5 px-4 py-1 hover:bg-opacity-10 focus:outline-none"
                    >
                  ...
                  {!stakePoolMetadata?.tokenStandard && (
                    <button
                      ...
                      className="text-md inline-block rounded-lg bg-white bg-opacity-5 px-4 py-1 hover:bg-opacity-90"
                    >
              ...
              <div className="my-3 flex-auto overflow-auto">
                <div
                  className="relative my-auto mb-4 h-[60vh] overflow-y-auto overflow-x-hidden rounded-lg bg-white p-5"
                  style={{
                    background:
                      stakePoolMetadata?.colors?.backgroundSecondary &&
                      (contrastColorMode(
                          ...
                          <div className="relative w-44 md:w-auto 2xl:w-48">
                            ...
                            >
                              ...
                              >
                                ...
                                />
                                <img
                                  className="mx-auto mt-4 rounded-t-xl bg-white bg-opacity-90 object-contain md:h-40 md:w-40 2xl:h-48 2xl:w-48"
                                  src={
                                ...
                                />
                                <div
                                  className={`flex-col rounded-b-xl p-2 text-black ${
                                  ...
                                  {showFungibleTokens && rewardMintInfo.data && (
                                    <div className="mt-2">
                                      ...
                                      <div className="flex w-full flex-row justify-between text-xs font-semibold">
                                        <span>Amount:</span>
                                        <input
                                          className="flex w-3/4 rounded-lg bg-transparent px-1 text-right text-xs font-medium focus:outline-none"
                                          type="text"
            ...
            <div
              className={`rounded-lg p-10 ${
                stakePoolMetadata?.colors?.fontColor ? '' : 'text-black'
              } bg-white bg-opacity-90`}
              style={{
                background: stakePoolMetadata?.colors?.backgroundSecondary,
                border: stakePoolMetadata?.colors?.accent
            ...
            >
              ...
              <div className="my-3 flex-auto overflow-auto">
                <div
                  className="relative my-auto mb-4 h-[60vh] overflow-y-auto overflow-x-hidden rounded-lg bg-white bg-opacity-90 p-5"
                  style={{
                    background:
                      stakePoolMetadata?.colors?.backgroundSecondary &&
                      (contrastColorMode(
                ...
                >
                  {!stakedTokenDatas.isFetched ? (
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                      <div className="h-[200px] animate-pulse rounded-lg bg-white bg-opacity-90 p-10"></div>
                      <div className="h-[200px] animate-pulse rounded-lg bg-white bg-opacity-90 p-10"></div>
                      <div className="h-[200px] animate-pulse rounded-lg bg-white bg-opacity-90 p-10"></div>
                    </div>
              ...
              <div className="mt-2 flex flex-row-reverse">
                ...
                >
                  ...
                  >
                    ...
                    <span className="my-auto text-white">
                      Unstake Jets ({stakedSelected.length})
                    </span>
                  </button>
                </MouseoverTooltip>
                {rewardDistributorData.data &&
                rewards.data?.claimableRewards.gt(new BN(0)) ? (
                  <button
                    ...
                    className="my-auto mr-5 flex rounded-lg px-4 py-2 hover:scale-[1.03]"
                  >
                    <span className="mr-1 inline-block">
                      {loadingClaimRewards && (
                        <LoadingSpinner
